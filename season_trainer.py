...
class Trainer:
    ...
    def val_process_batch(self, inputs):
    ...
    def evaluation(self, gt_depth, pred_depth):
    ...
    def compute_errors(self, pred_depth, gt_depth, c):
        """
    ...
    def align_img(self, pred_depth, gt_depth, c):
        """
